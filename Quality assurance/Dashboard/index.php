...
function getFaculty(){
  ...
  $query2 = "SELECT * FROM fac_new";
  $stmt3 = mysqli_prepare($conn, $query2);
  ...
  <main class="page">
    <div class="survey">
      ...
      <div class="question-holder enthusiasm">
        <h1 class="title head-title">Welcome, Dear Administrator!</h1>
        ...
        <div id="feechecker">
          <form id="selectionForm" method="post">
            <div class="form-group">
              ...
              <select class="form-control btn btn-primary submit" name="faculty" id="faculty" onchange="showUser(this.value)" required>
            ...
            <div align="left" class="input5"><span id="txtHint"></span></div>
          </form>
        </div>
      ...
      if (xmlhttp.readyState == 4) {
        ...
        setTimeout(function() {
          ...
          if (departmentSelect) {
            ...
            // Remove the submit button (it's added in getfield.php)
