...
<button class="trash logout" type="submit" name="logout">
  ...
  <main class="page">
    <div class="survey">
      ...
      <div class="contain">
        <h1 class="title head-li-title">Departmental Lecturers</h1>
    ...
    foreach ($lecturers as $value) {
      ...
      $lecturer= $lecture->getName(); 
      echo "<tr>";
      echo "<td>".$lecturer."</td>";
      echo "<td><a  style= 'background: red;' class='warning' href= 'delete_lecturer.php?lecturer=$value&id=$id'>Delete</a> </td>";
      echo "</tr>"; 
...
<button style= 'background: green; padding: 15px;' class='warning' onclick="showForm()">Add Lecturer</button>

<div class="contain" id="lecturerForm">
    <h3>Enter Lecturer Information</h3>
    <form action="#" method="post">
        <label for="lecturerName">Lecturer Name:</label>
        <input type="text" id="lecturerName" name="lecturerName" required>
        <button  style= 'background: green;' class='warning' type="submit">Submit</button>
    </form>
</div>
</div>
