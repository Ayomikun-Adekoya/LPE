...
<head>
  ...
  <title>Discharge Lecturer</title>
...
<body>
  ...
  <main class="page">
    ...
    while($row = mysqli_fetch_assoc($result)) {
        array_push($lecturer, ($row['lecturer_id']));
    }
    ...
    foreach ($lecturer as $value) {
      ...
      echo "<tr>";
      echo "<td>".$lecturer."</td>";
      echo "<td><a  style= 'background: red;' class='warning' href= 'remove.php?lecturer=$value&code=$code&id=$id'>Remove</a> </td>";
      echo "</tr>"; 
